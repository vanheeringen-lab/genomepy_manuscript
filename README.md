...
When a commit to the `master` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/vanheeringen-lab/genomepy_manuscript/tree/gh-pages) and [`output`](https://github.com/vanheeringen-lab/genomepy_manuscript/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://vanheeringen-lab.github.io/genomepy_manuscript/
+ **PDF manuscript** at https://vanheeringen-lab.github.io/genomepy_manuscript/manuscript.pdf
...
Please attribute by linking to https://github.com/vanheeringen-lab/genomepy_manuscript.
...
Please open [an issue](https://github.com/vanheeringen-lab/genomepy_manuscript/issues) for any question related to licensing.
